...
## Executing the tests
To run the sample project, you can either just run the `CucumberTestSuiteParallel` test runner class, or run either `mvn verify` or `gradle test` from the command line.
